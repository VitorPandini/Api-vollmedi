...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        var medicoLivre=repository.escolherMedicoAleatorioLivreNaData(Especialidade.CARDIOLOGIA,proximaSegundaAsDez);
        assertThat(medicoLivre).isNull();

    }

    @Test
    @DisplayName("Deveria devolver um medico livre na data ")
    ...
    private DadosEndereco dadosEndereco(){
        return new DadosEndereco("rua x","bairro","00000000","Hell de Janeiro","HJ",null,null);
    }
}